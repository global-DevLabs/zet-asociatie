...
export function GroupDetailClient({ id }: { id: string }) {
  ...
  const handleExport = () => {
    ...
    toast({ title: "Succes", description: "Membri exportați în CSV" })
  }

  const handleArchiveToggle = async () => {
    try {
      await updateGroup(id, { status: group.status === "Active" ? "Archived" : "Active" })
      toast({
        title: "Succes",
  ...
  const handleRemoveMember = async () => {
    ...
    toast({ title: "Succes", description: "Membru eliminat din grup" })
  }
      ...
      <AlertDialog open={!!memberToRemove} onOpenChange={() => setMemberToRemove(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Ești sigur că vrei să elimini acest membru din grup? Această acțiune poate fi anulată adăugând din nou membrul.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
