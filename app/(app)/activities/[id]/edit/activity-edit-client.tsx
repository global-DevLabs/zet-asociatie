...
export function ActivityEditClient({ id }: { id: string }) {
  ...
  if (!isLoading && !activity) notFound()
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast({ title: "Succes", description: "Activitatea a fost actualizată" })
      router.push(`/activities/${id}`)
    } catch {
      toast({
        title: "Eroare",
        ...
        <CardContent>
          <div className="grid gap-6">
            <div className="grid gap-2">
              <Label htmlFor="type">Tip Activitate <span className="text-red-500">*</span></Label>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="grid gap-2">
                <Label htmlFor="date_from">Data începere <span className="text-red-500">*</span></Label>
                <DatePickerInput
            ...
            <div className="flex justify-end gap-2 pt-4 border-t">
              <Button variant="outline" onClick={() => router.push(`/activities/${id}`)} disabled={isSaving}>
                Anulează
              </Button>
